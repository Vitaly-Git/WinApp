...
BOOL CreateElements(HWND parenthWnd) {
    ...
    CreateWindow(TEXT("Edit"), TEXT("test"), WS_CHILD | WS_VISIBLE | WS_BORDER, 10, 10, 140, 20, parenthWnd, NULL, NULL, NULL);
    ...
    HWND hwndButton = CreateWindow(
        ...
        (HMENU)WindowsElements::BUTTON_OK,     // No menu.
